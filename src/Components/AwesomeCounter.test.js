...
test("it should have correct initial value when set to 7", () => {
    render(<AwesomeCounter initialValue={7}/>);
    const count = screen.queryByText(7);
    expect(count).toBeVisible();
});

test("it should have a defautlt initial value of 0", () => {
...
test("it should not allow a negative value when the initial value is 0 and remove is clicked", () => {
...
test("it should not allow a negative value when the initial value is 2 and remove is clicked 4 times", () => {
